...
\begin{tabular}{lc}
Author's Full Name &: \rule{10cm}{0.4pt}\\
Date of Birth &: \rule{10cm}{0.4pt}\\
Title &: \rule{10cm}{0.4pt}\\
 &: \rule{10cm}{0.4pt}\\ 
 &: \rule{10cm}{0.4pt}\\ 
 %&: \rule{10cm}{0.4pt}\\
 Academic session &: \rule{10cm}{0.4pt}\\
\end{tabular}
...
\begin{tabular}[h]{p{1cm}p{5cm}p{1cm}p{5cm}}
& \rule{5cm}{0.4pt} & & \rule{5cm}{0.4pt}\\
& New IC/Passport Number & & Assoc Prof Ts Dr Muhammad Aizzat Bin Zakaria, CEng\\
& Date: & & Date:
\end{tabular}
